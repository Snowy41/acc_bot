...
import SystemMessage from "./components/notification/SystemMessage";
...
import ShopItemDetail from "./components/shop/ShopItemDetails";
...
function AppLayout() {
  ...
  useEffect(() => {
    ...
    socket.on("dm", handleChatMessage);
